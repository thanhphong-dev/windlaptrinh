!(function (e, t) {
  ...
  var I = function (e) {
    ...
    D = function (t) {
      ...
      if (
        (t.position in o && P(S, o[t.position]),
      ...
      t.showCloseButton
        ? (j.setAttribute("aria-label", t.closeButtonAriaLabel), q(j))
        : V(j),
        (n.className = o.popup),
        t.toast
          ? (P(document.body, o["toast-shown"]), P(n, o.toast))
          : P(n, o.modal),
          ...
          switch (t.type) {
            case "success":
              P(Q, "swal2-animate-success-icon"),
                P(
                  Q.querySelector(".swal2-success-line-tip"),
                  "swal2-animate-success-line-tip"
                ),
                P(
                  Q.querySelector(".swal2-success-line-long"),
      ...
      t.imageUrl
        ...
        t.buttonsStyling &&
          ((T.style.backgroundColor = t.confirmButtonColor),
      ...
      return new Promise(function (t, n) {
            ...
            R = function (t) {
              ...
              switch (n.type) {
                ...
                case "mouseout":
                  a.buttonsStyling &&
                    (u
                      ? (r.style.backgroundColor = a.confirmButtonColor)
                      : d && (s.style.backgroundColor = a.cancelButtonColor));
                  break;
                case "mousedown":
                  a.buttonsStyling &&
                    (u
          ...
          a.toast
            ? (m.onclick = function (t) {
                t.target !== m ||
                  ...
                  a.showCancelButton ||
                  (a.allowOutsideClick &&
                    (e.closePopup(a.onClose), l("overlay")));
              })
        ...
        var Y = function (e, t) {
          ...
          _ = function (t) {
            var n = t || window.event;
            if ("Enter" === n.key)
              n.target === M() && (e.clickConfirm(), n.preventDefault());
            else if ("Tab" === n.key) {
              for (
        ...
        (window.onkeydown && window.onkeydown.toString() === _.toString()) ||
          ((u.previousWindowKeyDown = window.onkeydown),
          (window.onkeydown = _)),
          a.buttonsStyling &&
            ((Z.style.borderLeftColor = a.confirmButtonColor),
            (Z.style.borderRightColor = a.confirmButtonColor)),
          (e.hideLoading = e.disableLoading =
            function () {
              a.showConfirmButton || (V(Z), a.showCancelButton || V(x())),
                L(z, o.loading),
                L(m, o.loading),
        ...
        switch (a.input) {
          ...
          case "checkbox":
            ...
            pe.length && ce.removeChild(pe[0]),
              ((pe = document.createElement("span")).innerHTML =
                a.inputPlaceholder),
              ce.appendChild(pe),
              q(ce);
            break;
          ...
          if (n) {
            L(n, o.show),
              ...
              document.body.classList.contains(o["toast-shown"]) ||
                (function () {
                  if (
                    ((window.onkeydown = u.previousWindowKeyDown),
            ...
            var r = function () {
              t.parentNode && t.parentNode.removeChild(t),
                ...
                A() &&
                  (null !== u.previousBodyPadding &&
                    ((document.body.style.paddingRight = u.previousBodyPadding),
