!(function (e, t) {
  ...
  var e = {
      ...
      return (
        ...
        t.concat(
          Array.prototype.slice.call(
            u().querySelectorAll(
              "button:not([class^=swal2-]), input:not([type=hidden]), textarea, select"
            )
          )
        )
      );
    ...
    O = function () {
      if (
        ((window.onkeydown = i.previousWindowKeyDown),
    ...
    W = function (t) {
      ...
      if (
        (t.titleText
          ? (l.innerText = t.titleText)
          : (l.innerHTML = t.title.split("\n").join("<br>")),
        t.text || t.html)
      ) {
        if ("object" === N(t.html))
      ...
      t.imageUrl
        ? (I.setAttribute("src", t.imageUrl),
          A(I),
          t.imageWidth
            ? I.setAttribute("width", t.imageWidth)
            : I.removeAttribute("width"),
          t.imageHeight
            ? I.setAttribute("height", t.imageHeight)
    ...
    Q = function () {
      null !== i.previousBodyPadding &&
        ((document.body.style.paddingRight = i.previousBodyPadding),
      ...
      return new Promise(function (t, o) {
            ...
            M = function (t) {
              ...
              switch (n.type) {
                ...
                case "mouseout":
                  l.buttonsStyling &&
                    (u
                      ? (a.style.backgroundColor = l.confirmButtonColor)
        ...
        (w().onclick = function () {
          ...
          (c.onclick = function (t) {
            t.target === c &&
              l.allowOutsideClick &&
              (e.closeModal(l.onClose), o("overlay"));
          });
        var H = g(),
          j = b();
        l.reverseButtons
          ? H.parentNode.insertBefore(j, H)
          : H.parentNode.insertBefore(H, j);
        var K = function (e, t) {
          ...
          D = function (t) {
            ...
            if ([9, 13, 32, 27].indexOf(r) !== -1) {
              ...
              9 === r
                ? (n.shiftKey ? K(s, -1) : K(s, 1),
                  n.stopPropagation(),
                  n.preventDefault())
                : 13 === r || 32 === r
                ? s === -1 &&
                  l.allowEnterKey &&
                  (l.focusCancel ? q(j, n) : q(H, n))
                : 27 === r &&
                  l.allowEscapeKey === !0 &&
                  (e.closeModal(l.onClose), o("esc"));
            }
          };
        (i.previousWindowKeyDown = window.onkeydown),
          ...
          (e.hideLoading = e.disableLoading =
            function () {
              l.showConfirmButton || (P(H), l.showCancelButton || P(v())),
                E(H, n.loading),
                E(d, n.loading),
                (H.disabled = !1),
                (j.disabled = !1);
  ...
  return (
    ...
    ($.queue = function (e) {
      ...
      return new Promise(function (e, o) {
        !(function r(i, a) {
          0 < D.length
            ? (document.body.setAttribute("data-swal2-queue-step", 0),
              $(D[0]).then(
                function (e) {
                  n.push(e), r(1, void 0);
                },
