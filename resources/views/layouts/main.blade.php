...
<head>
    ...
    <link href={{ asset('default/css/wind.css') }} type="text/css" rel="stylesheet">
    <link href={{ asset('default/css/wind_new.css') }} type="text/css" rel="stylesheet">
    <link href={{ asset('default/css/wind_new_new.css') }} type="text/css" rel="stylesheet">
                            ...
                            <div class="navsub-primary-menu flex-align-primary">
                                <div class="navbar-logo">
                                    <a class="logo-primary" href="index.htm">
                                        <img class="hide-scroll svg_logo_loyalty" src={{asset("images/logo/wind-2.png")}}
                                        ...
                                        <ul class="cnv-submenu row">
                                            <li class="col-lg-6 col-xs-6 list-sub">
                                                <a target=" _self" class="smooth icon " href={{url("/function")}}
                                                    title="">
                                                    <img src={{asset("storage/icons/uu-dai.png")}} alt="" title="">
                                                    <img src={{asset("storage/icons/uu-dai.png")}} alt="" title="">
                                                </a>
    ...
    <section class="banner-ads" style="background-image: url({{asset('./images/solution/contact.jpg')}})">
        <div class="container">
            <div class="box-tech-home">
                <h2 class="title text-white"><strong class="title-tech-home">Đội ngủ lập trình GenZ</strong> nền tảng giải pháp lập trình sáng tạo và chuyên nghiệp</h2>
            </div>
            ...
            <div class="row col-mar-0 footer-lien-he" id="lien-he">
                <div class="col-lg-5 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                    <a class="logo" href="index.htm" title="">
                        <img class="lazy" data-src={{asset("./images/logo/wind.png")}}
                ...
                <div class="col-lg-7">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-auto col-md-4 wow ">
                            ...
                            <ul>
                                <li class="smooth">Marketing</li>
                                <li class="smooth">Thiết kế Website</li>
                                <li class="smooth">Thiết kế Sofware</li>
                                <li class="smooth">Thiết kế MiniApp</li>
                                <li class="smooth">BranTech</li>
                        ...
                        <div class="col-xl-auto col-md-4 wow ">
                            ...
                            <ul>
                                <li>
                                    <a class="smooth" href="">Email</a>
                                </li>
                                <li>
                                    <a class="smooth" href="">Tiktok</a>
                                </li>
                                <li>
                                    <a class="smooth" href="">Facebook</a>
                                </li>
                                <li>
                                    <a class="smooth" href="">Zalo</a>
                                </li>
                                <li>
                                    <a class="smooth" href="">WhatsApp</a>
                                </li>
                            </ul>
                        </div>
                    </div>
